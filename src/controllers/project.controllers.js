...
const addMembersToProject = asyncHandler(async(req,res)=>{
    ...
    return res
        .status(201).json(new ApiResponse(201,{},"project member added successfully"))
...
const updateMemberRole = asyncHandler(async (req,res)=>{
    ...
    let projectMember = ProjectMember.findOne({
        project:new mongoose.Types.ObjectId(projectId),
        project:new mongoose.Types.ObjectId(userId)
    })
...
const deleteMember = asyncHandler(async(req,res) =>{
   ...
   projectMember = await ProjectMember.findByIdAndDelete(
    ...
    return res
          .status(200)
          .json(new ApiResponse(200,projectMember,"Project member delete successfully"))
